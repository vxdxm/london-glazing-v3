      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <ContactFormInput id="name" label="Name" value={name} onChange={e => setName(e.target.value)} required disabled={isSubmitting} />
            <ContactFormInput id="email" label="Email" type="email" value={email} onChange={e => setEmail(e.target.value)} required disabled={isSubmitting} />
            <ContactFormTextarea id="message" label="Message" value={message} onChange={e => setMessage(e.target.value)} required disabled={isSubmitting} />
