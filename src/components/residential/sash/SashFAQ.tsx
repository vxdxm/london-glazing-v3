  ...
  return (
    <section className="mb-12">
      ...
      <p className="text-muted-foreground mb-8">
        For <Link to="/secondary-glazing-repairs" className="text-primary hover:underline">professional sash window repair services</Link> including spiral balance replacement and maintenance, our specialist team can help. Read our <Link to="/blog/secondary-glazing-cost-london" className="text-primary hover:underline">complete guide to secondary glazing costs</Link> for detailed pricing information.
      </p>
