  ...
  return <section className="mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <img loading="lazy" decoding="async" src="/lovable-uploads/7b385715-0bca-41ee-be8b-7df9caa5ac51.png" alt="Modern bay window system" className="rounded-lg w-full h-[200px] object-cover mb-4" />
              <p className="text-gray-700">
