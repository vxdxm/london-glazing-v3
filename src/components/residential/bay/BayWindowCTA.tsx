...
const BayWindowCTA = () => {
  ...
  return (
    <section className="text-center mb-12 bg-gray-50 p-8 rounded-lg">
      <h2 className="text-2xl font-bold mb-6">Ready to Transform Your Bay Windows?</h2>
      <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
        Contact us today for a free consultation and quote. Our experts will help you 
        find the perfect bay window solution that maintains the character of your property
