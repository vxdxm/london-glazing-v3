  ...
  return <div className="py-12">
      ...
      <div className="w-full max-w-4xl mx-auto">
        <AspectRatio ratio={16 / 9} className="bg-muted">
          <img loading="lazy" decoding="async" alt="Side by side comparison of single and double glazed secondary windows" className="object-cover w-full h-full rounded-lg" src="/lovable-uploads/9843c321-bf8c-4eea-a1b3-09d57c35998d.jpg" />
        </AspectRatio>
