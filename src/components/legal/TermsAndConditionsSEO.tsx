...
const TermsAndConditionsSEO = () => {
  return (
    <Helmet>
      ...
      <meta property="og:description" content="Read our terms and conditions to understand the rules and guidelines for using our website and services." />
      ...
      <meta property="twitter:description" content="Read our terms and conditions to understand the rules and guidelines for using our website and services." />
