...
const PrivacyPolicySEO = () => {
  return (
    <Helmet>
      ...
      <meta 
        name="description" 
        content="Our privacy policy explains how we collect, use and protect your data when using our secondary glazing services and website." 
      />
      ...
      <meta property="og:description" content="Our privacy policy explains how we collect, use and protect your data when using our secondary glazing services and website." />
      ...
      <meta name="twitter:description" content="Our privacy policy explains how we collect, use and protect your data when using our secondary glazing services and website." />
