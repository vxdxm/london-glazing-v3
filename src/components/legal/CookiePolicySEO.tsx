...
const CookiePolicySEO = () => {
  return (
    <Helmet>
      ...
      <meta 
        name="description" 
        content="Learn how we use cookies on our secondary glazing website." 
      />
      ...
      <meta property="og:description" content="Learn how we use cookies on our secondary glazing website." />
      ...
      <meta name="twitter:description" content="Learn how we use cookies on our secondary glazing website." />
