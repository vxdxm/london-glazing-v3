  ...
  return <section className="mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <img loading="lazy" decoding="async" alt="Casement window with secondary glazing improving thermal insulation in a London home" className="rounded-lg w-full h-[200px] object-cover mb-4" src="/lovable-uploads/6c55e910-40fc-40eb-9b56-6c464e1e1c72.jpg" />
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <img loading="lazy" decoding="async" alt="Acoustic secondary glazing fitted to a casement window to reduce traffic noise" src="/lovable-uploads/bd7952fe-d76a-4c87-96f0-3505aa8ca4b4.jpg" className="rounded-lg w-full h-[200px] mb-4 object-fill" />
              <p className="text-gray-700">
