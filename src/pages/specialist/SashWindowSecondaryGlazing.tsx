        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Maintain the traditional functionality of your sash windows with our vertical 
              sliding secondary glazing. Designed to match the operation of original box sash 
              windows, our systems provide exceptional thermal and acoustic performance.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              replicates this movement perfectly. Unlike fixed panels or hinged units, 
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              ...
              both the secondary glazing and your original windows.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12 not-prose">
              <Card className="border-sky-200">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-foreground mb-3">Vertical Sliding</h3>
              ...
              <Card className="border-sky-200">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-foreground mb-3">Lift-Out Panels</h3>
                  <p className="text-sm text-muted-foreground mb-4">
              ...
              <Card className="border-sky-200">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-foreground mb-3">Hinged Casement</h3>
                  <p className="text-sm text-muted-foreground mb-4">
              ...
              <Card className="border-sky-200">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-foreground mb-3">Fixed Panels</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Non-opening panels for windows that do not require ventilation, 
                    offering maximum acoustic performance.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2 text-muted-foreground">
                      <CheckCircle className="h-4 w-4 text-green-600" />
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12 not-prose">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Thermal Insulation</h3>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              glazing, providing minimal insulation.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              ...
              addresses both draughts and thermal performance.
            </p>
