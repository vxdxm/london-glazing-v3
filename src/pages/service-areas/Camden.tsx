...
const Camden = () => {
  const conservationAreas = [
    "Hampstead", "Highgate", "Belsize Park", "Primrose Hill", "Bloomsbury",
    "Fitzrovia", "Camden Town", "Kentish Town", "Gospel Oak", "Parliament Hill",
    "Dartmouth Park", "Camden Square", "Rochester", "Regents Park"
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Expert secondary glazing for Camden's Victorian and Edwardian properties. Specialists in Hampstead, Belsize Park and Bloomsbury conservation areas. Free surveys."
        />
        <meta 
          name="keywords" 
          content="secondary glazing Camden, Hampstead secondary glazing, Bloomsbury glazing, Camden conservation area, Victorian windows Camden, heritage glazing North London"
        />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Secondary Glazing Camden
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Camden is renowned for its stunning <Link to="/victorian-windows-secondary-glazing" className="text-primary hover:underline">Victorian</Link> and 
              <Link to="/edwardian-property-secondary-glazing" className="text-primary hover:underline"> Edwardian</Link> architecture, 
              from the grand villas of Hampstead to the elegant terraces of Bloomsbury. Our specialist 
              secondary glazing protects these <Link to="/listed-buildings-secondary-glazing" className="text-primary hover:underline">listed buildings</Link> and 
              <Link to="/conservation-areas-secondary-glazing" className="text-primary hover:underline"> conservation area</Link> properties 
              while delivering exceptional <Link to="/thermal-insulation-secondary-glazing" className="text-primary hover:underline">thermal</Link> and 
              <Link to="/noise-reduction-secondary-glazing" className="text-primary hover:underline"> noise reduction</Link> performance.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-3xl font-bold mb-6">Secondary Glazing Experts for Camden</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Camden boasts one of London's richest concentrations of period architecture. From the 
                  <Link to="/locations/edwardian-hampstead" className="text-primary hover:underline"> Edwardian villas of Hampstead</Link> to 
                  the <Link to="/georgian-windows-secondary-glazing" className="text-primary hover:underline">Georgian squares</Link> of Bloomsbury, 
                  the borough contains thousands of listed buildings and over 40 conservation areas that 
                  require sensitive window solutions.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  the perfect solution for Camden homeowners. Installed internally behind your existing 
                  <Link to="/residential/sash-windows" className="text-primary hover:underline"> sash windows</Link> or 
                  <Link to="/residential/casement-windows" className="text-primary hover:underline"> casement windows</Link>, 
                  it is completely invisible from the street, meaning no planning permission is typically required.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Camden properties face particular noise challenges, from the busy Euston Road corridor to 
                  train noise near <Link to="/locations/kings-cross-train-noise" className="text-primary hover:underline">Kings Cross</Link>. 
                  Our <Link to="/noise-reduction-secondary-glazing" className="text-primary hover:underline">acoustic glazing</Link> reduces 
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Camden has over 40 conservation areas. We provide specialist 
              ...
              {/* Benefits Section */}
              <div>
                <h2 className="text-3xl font-bold mb-6">Benefits for Camden Properties</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        ...
                        bay windows and tall sashes common in Camden Victorian properties.
                      </p>
                    </CardContent>
                  </Card>
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        Block up to 80% of traffic and rail noise with our acoustic glazing. Ideal for 
                        properties near busy Camden roads and rail lines.
                      </p>
                    </CardContent>
                  </Card>
                  <Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        Add security with laminated glass options, providing significant resistance 
                        to forced entry for ground-floor and basement windows.
                      </p>
                    </CardContent>
                  </Card>
                </div>
              ...
              {/* Our Approach */}
              <div className="prose prose-lg max-w-none">
                <h2 className="text-3xl font-bold mb-6">Our Camden Service</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  We have been serving Camden homeowners for over 15 years, from Hampstead Heath to 
                  <Link to="/service-areas/islington" className="text-primary hover:underline"> Islington</Link> borders. 
                  Our team understands Camden Council conservation requirements and works closely with 
                  heritage officers when required.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <div className="bg-primary text-primary-foreground rounded-lg p-8 text-center">
                <h2 className="text-2xl font-bold mb-4">Get Your Free Camden Survey</h2>
